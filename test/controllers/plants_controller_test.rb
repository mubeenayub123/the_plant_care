...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference("Plant.count") do
      post plants_url, params: { plant: { name: @plant.name, required_soil_moisture: @plant.required_soil_moisture } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { name: @plant.name, required_soil_moisture: @plant.required_soil_moisture } }
